    ...
    return(
        <div className="flex flex-col justify-center align-middle pt-16 pb-8 mx-6">
            ...
            <form action="" className="flex flex-col">
                ...
                <input className="mx-auto bg-LightgrayUbihere-0 w-full max-w-[450px] mx- p-5 placeholder:text-DarkgrayUbihere-0 rounded-[28px] mb-3" type="password" placeholder="Confirme sua palavra passe" />
